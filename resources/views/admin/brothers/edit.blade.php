...
@section('content_header')
    <h1>Editar información del hermano</h1>
@stop
...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-3">
            <div class="card">
                <div class="card-body">
                    {!! Form::model($brother, ['route' => ['admin.brothers.update',$brother], 'method' => 'put']) !!}
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('identificador', null, ['class' => 'form-control', 'placeholder' => 'Ingrese la cédula del hermano']) !!}
