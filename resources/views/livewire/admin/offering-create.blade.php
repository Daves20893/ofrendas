    ...
    <div class="w-sfull">
        <div class="card mb-n1">
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'admin.offerings.store']) !!}
                    <div class="row">
                        <div class="col-sm-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                {!! Form::label('id', 'Id') !!}
                                {{-- {!! Form::text('id', null, ['class' => 'form-control', 'placeholder' => 'id' , 'wire:model' => 'ofrenda_id', 'readonly']) !!} --}}
                                <input class="form-control" type="text" wire:model="ofrenda_id" id="id">
                                <p>{{ $ofrenda_id }}</p>
                                <p>{{ $ofrenda }}</p>
                            </div>
                        </div>
